...
<?php
  ...
  if (isset($_POST['cupload'])) {
    ...
    $tempname = $_FILES["cast_certificate"]["tmp_name"];
        $folder = "cast_certificate/".$filename;
          
    $db = mysqli_connect("localhost", "root", "", "collegedb");
  
        // Get all the submitted data from the form
        $sql = "UPDATE admission SET cast_certificate='$filename' where username='$_SESSION[username]'";
